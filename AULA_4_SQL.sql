...
/* ================= EXERCÍCIO 1 =================
Conte quantos empregados existem na tabela tb_empregado.
Treina: COUNT()
*/
...
/* ================= EXERCÍCIO 2 =================
Calcule o total gasto com salários utilizando a tabela tb_cargo.
Treina: SUM()
*/

SELECT SUM(salario) AS 'GG' FROM tb_cargo;
 



/* ================= EXERCÍCIO 3 =================
Determine a média salarial registrada na tabela tb_cargo.
Treina: AVG()
*/

SELECT AVG(salario) AS 'media' FROM tb_cargo;  


/* ================= EXERCÍCIO 4 =================
Liste os cargos e a quantidade de empregados em cada um, sem utilizar JOIN.
Treina: GROUP BY
*/

SELECT fk_cargo, COUNT(*) AS 'total'
FROM tb_empregado 
GROUP BY fk_cargo; 
...
/* ================= EXERCÍCIO 5 =================
Liste os departamentos que possuem mais de 2 empregados utilizando subquery.
Treina: SUBQUERY + HAVING
*/
...
/* ================= EXERCÍCIO 6 =================
Recupere o nome do cargo que possui o maior salário utilizando uma subquery.
Treina: SUBQUERY + MAX()
*/

SELECT 
	nm_cargo AS 'Mais rico ;0'
FROM 
	tb_cargo
WHERE salario = ( 
	SELECT MAX(salario)
...
/* ================= EXERCÍCIO 7 =================
Liste os nomes e matrículas dos empregados cujo salário está acima da média salarial geral.
Treina: SUBQUERY com AVG()
*/
...
/* ================= EXERCÍCIO 8 =================
Recupere o nome de todos os empregados cujo cargo possua salário maior que o cargo 'Administrador'.
Treina: SUBQUERY dentro de outra SUBQUERY
*/
SELECT 
    nome
FROM 
...
/* ================= EXERCÍCIO 9 =================
Liste os departamentos que não possuem nenhum funcionário com cargo de 'Programador'.
Treina: NOT IN
*/
SELECT nm_departamento
...
/* ================= EXERCÍCIO 10 =================
Liste o nome de todos os departamentos e, ao lado, mostre quantos funcionários existem em cada um,
utilizando uma subquery no SELECT.
Treina: SUBQUERY no SELECT
*/
...
(SELECT COUNT(*) 
FROM tb_empregado e 
WHERE e.fk_departamento = d.id_departamento) AS 'Total funcionarios'
FROM tb_departamento d; 
